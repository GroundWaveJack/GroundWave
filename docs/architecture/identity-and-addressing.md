...
Human, device, service, and group identities must not be collapsed. External profile addresses bind to a Harriet identity only through explicit, verifiable statements with scope and expiration. Discovery does not itself establish trust.
